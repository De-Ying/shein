...
@section('meta_title', 'Chi tiết bài viết')
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="blog__details__content">
                        <div class="blog__details__item">
                            <img src="{{ asset('public/frontend/images/defaults/blog/detail/750x500.png') }}" alt="">
                        ...
                        <div class="blog__details__comment">
                            ...
                            <div class="blog__comment__item">
                                <div class="blog__comment__item__pic">
                                    <img src="{{ asset('public/frontend/images/defaults/blog/comment/90x90.png') }}" alt="">
                                </div>
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <a href="#" class="blog__feature__item">
                                <div class="blog__feature__item__pic">
                                    <img src="{{ asset('public/frontend/images/defaults/blog/sidebar/110x73.png') }}" alt="">
                                </div>
